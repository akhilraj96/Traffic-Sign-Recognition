...
# Load your model
model = load_model("artifacts/model") # Path to your model
...
def preprocess_image(image):
    ...
    if resized_image.shape[-1] == 1:  # Grayscale image
        resized_image = resized_image / 255.0  # Normalize the image to [0, 1]
    else:  # Color image
        resized_image = tf.image.rgb_to_grayscale(resized_image) / 255.0  # Convert to grayscale and normalize
